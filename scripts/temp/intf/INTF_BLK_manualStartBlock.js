...
*/
  ...
  function comp_init(blk) {
    ...
    let scr = b => {
      b.ex_accManualStartWarmup(Mathf.lerp(b.ex_accManualStartWarmup("read"), 1.2, blk.manualStartDecRate * 1.65));
  ...
  function comp_updateTile(b) {
    if(b.efficiency < 0.0001 || !b.shouldConsume()) {
      b.manualStartWarmup = Mathf.lerpDelta(b.manualStartWarmup, 0.0, b.block.ex_getManualStartDecRate());
    } else {
      b.manualStartWarmup = Mathf.lerpDelta(b.manualStartWarmup, 1.4, b.block.ex_getManualStartIncRate());
    };
  ...
  function comp_ex_configureClick(b) {
    let cfgVal = null;
    switch(b.block.ex_getManualStartCfgTp()) {
      case "boolean" :
        cfgVal = true;
        break;
      case "string" :
