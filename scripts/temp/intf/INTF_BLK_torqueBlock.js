...
*/
  ...
  function comp_setBars(blk) {
    ...
    blk.addBar("lovec-tor", b => new Bar(
      ...
      () => Mathf.clamp(b.ex_accTorCur("read") / blk.size / Math.max(b.ex_accRpmCur("read"), 0.1)),
    ));
  };
  ...
  function comp_updateTile(b) {
    ...
    b.ex_updateTor();
    if(!b.block.ex_getSkipTorSupply()) {
      b.ex_supplyTor();
    };
  ...
  function comp_ex_updateTor(b) {
    ...
    while(i < iCap) {
      ...
      if(b.ex_checkTorTransValid(ob)) {
        amtTransTg = (ob.ex_accTorCur("read") + b.torCur) * 0.5;
        ob.ex_accTorCur(amtTransTg);
        b.torCur = amtTransTg;
      };
      i++;
    };
