...
*/
  ...
  function comp_setStats(blk) {
    blk.stats.add(TP_stat.blk0env_ventSize, "[$1]x[$1]".format(blk.ventSize));
  };
  ...
  function comp_ex_getMatGrp(blk) {
    return tryFun(blk.parent.ex_getMatGrp, blk.parent, "none");
  };
...
*/
  ...
  module.exports = new CLS_interface({
    ...
    ex_getMatGrp: function() {
      return comp_ex_getMatGrp(this);
    }
    .setProp({
      noSuper: true,
      override: true,
