...
*/
  ...
  function comp_updateTile(b) {
    if(b.block.ex_getStaTg() == null) return;
    ...
    if(b.charge > b.block.reload - 0.0001) {
      ...
      if(rad > 1.0) MDL_pos._it_units(
        b.x, b.y, rad, null,
        ounit => b.block.ex_getFilterScrTup()[0](b, ounit),
        ounit => ounit.apply(b.block.ex_getStaTg(), b.block.ex_getStaDur()),
      );
    };
  };
...
*/
  ...
  module.exports = [
    ...
    .setGetter("staTg", "staDur", "filterScrTup"),
