...
*/
  ...
  function comp_getTileTarget(b, itm, b_f, isFlip) {
    ...
    if((b.block.ex_getFilterScrTup()[0](b, b_f, itm) !== b.isInv) === b.enabled) {
  ...
  function comp_buildConfiguration(b, tb) {
    if(!b.block.ex_getHideSelection()) {
  ...
  function comp_draw(b) {
    if(b.isInv) MDL_draw._reg_normal(b.x, b.y, b.block.ex_getInvReg());
  };
...
*/
  ...
  module.exports = [
    ...
    .setGetter("filterScrTup", "hideSelection", "invReg"),
