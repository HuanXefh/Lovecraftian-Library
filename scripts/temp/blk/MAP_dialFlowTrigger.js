...
*/
  ...
  function comp_ex_onFlagTriggered(b) {
    ...
    if(VARGEN.dialFlowNmCtMap.containsKey(b.nmDialFlow)) {
  ...
  module.exports = [
    ...
    .setMethod({
      ...
      ex_getFlagStr: function(b) {
        return "dialFlow: " + b.ex_accNmDialFlow("read");
      }
      .setProp({
        noSuper: true,
        override: true,
