...
*/
  ...
  function comp_draw(b) {
    if(b.block.ex_getNoSideReg()) return;

    if(b.shouldDrawSide1) MDL_draw._reg_side(b.x, b.y, b.block.ex_getSideReg1(), b.block.ex_getSideReg1(), b.rotation, null, null, Layer.block - 0.19);
    if(b.shouldDrawSide2) MDL_draw._reg_side(b.x, b.y, b.block.ex_getSideReg2(), b.block.ex_getSideReg2(), (b.rotation + 2) % 4, null, null, Layer.block - 0.19);
  };
...
*/
  ...
  module.exports = [
    ...
    .setGetter("noSideReg", "sideReg1", "sideReg2"),
