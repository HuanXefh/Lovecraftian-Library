...
*/
  ...
  function comp_setBars(blk) {
    ...
    blk.addBar("liquid", b => new Bar(
      b.ex_getDynaAttrRs() != null ? b.ex_getDynaAttrRs().localizedName : Core.bundle.get("bar.liquid"),
      b.ex_getDynaAttrRs() != null ? tryVal(b.ex_getDynaAttrRs().barColor, b.ex_getDynaAttrRs().color) : Color.clear,
      () => b.ex_getDynaAttrRs() == null ? 0.0 : Mathf.clamp(b.liquids.get(b.ex_getDynaAttrRs()) / blk.liquidCapacity),
    ));
  };
  ...
  function comp_draw(b) {
    ...
    MDL_draw._reg_normal(b.x, b.y, b.liqReg, 0.0, 1.0, b.dynaAttrRs, b.liquids.get(b.dynaAttrRs));
  };
