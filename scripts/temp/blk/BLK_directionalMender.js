...
*/
  ...
  function comp_updateTile(b) {
    ...
    if(b.charge > b.block.reload && cond) {
      ...
      if(ob != null && MDL_cond._canHeal(ob)) {
        FRAG_attack.heal(ob, (ob.maxHealth * b.block.ex_getBHealPerc() + b.block.ex_getBHealAmt()) * b.efficiency, true);
      };
    };
  };
  ...
  function comp_draw(b) {
    ...
    Draw.rect(b.rotation < 2 ? b.block.ex_getSideReg1() : b.block.ex_getSideReg2(), b.x, b.y, b.drawrot());
...
*/
  ...
  module.exports = [
    ...
    .setGetter("bHealAmt", "bHealPerc", "sideReg1", "sideReg2"),
