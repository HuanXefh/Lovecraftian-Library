...
*/
  ...
  function comp_init(blk) {
    ...
    blk.config(JAVA.OBJECT_ARRAY, (b, cfgArr) => {
      ...
      if(cfgArr[0] === "BLK_multiFilterGate") {
  ...
  function comp_getTileTarget(b, itm, b_f, isFlip) {
    ...
    if((b.filterScr(b, b_f, itm, b.rsTgs) !== b.isInv) === b.enabled) {
...
*/
  ...
  const TEMPLATE = {
    ...
    // @NOSUPER
    config: function(b) {
      return ["BLK_multiFilterGate", b.isInv].pushAll(b.rsTgs.map(rs => rs == null ? "null" : rs.name)).toJavaArr();
    },
