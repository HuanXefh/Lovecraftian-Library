...
*/
   ...
   * NOTE:
   *
   * Whether this unit is an infantry unit (mech and small leg unit).
   * ---------------------------------------- */
  const _isInfantryUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-inf", "utp");
  };
  exports._isInfantryUnit = _isInfantryUnit;


  /* ----------------------------------------
   * NOTE:
   *
   * Whether this unit is a vehicle unit (tank and other wheeled units).
   * ---------------------------------------- */
  const _isVehicleUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-veh", "utp");
  };
  exports._isVehicleUnit = _isVehicleUnit;


  /* ----------------------------------------
   * NOTE:
   *
   * Whether this unit is a hearvy vehicle unit (armored tank).
   * ---------------------------------------- */
  const _isHeavyVehicleUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-hev0veh", "utp");
  };
  exports._isHeavyVehicleUnit = _isHeavyVehicleUnit;


  /* ----------------------------------------
   * NOTE:
   *
   * Whether this unit is a drone unit (a type of flyer).
   * ---------------------------------------- */
  const _isDroneUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-drone", "utp");
  };
  exports._isDroneUnit = _isDroneUnit;


  /* ----------------------------------------
   * NOTE:
   *
   * Whether this unit is a jet unit (a type of flyer).
   * ---------------------------------------- */
  const _isJetUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-jet", "utp");
  };
  exports._isJetUnit = _isJetUnit;


  /* ----------------------------------------
   * NOTE:
   *
   * Whether this unit is an experimental unit (powerful).
   * ---------------------------------------- */
  const _isExperimentalUnit = function(utp_gn) {
    return matchTag(utp_gn, "utp-exp", "utp");
  };
  exports._isExperimentalUnit = _isExperimentalUnit;
